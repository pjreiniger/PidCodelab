...
public abstract class TempBaseRamseteCoordinateGuiCommand extends CommandBase {
    protected final Timer m_timer = new Timer();
    protected final Supplier<Trajectory> m_trajectorySupplier;
     ...
     */
    public TempBaseRamseteCoordinateGuiCommand(
        Trajectory trajectory,
        RamseteController follower,
        DifferentialDriveKinematics kinematics,
        Subsystem... requirements) {
        this(() -> trajectory, follower, kinematics, requirements);
    }
    ...
    public TempBaseRamseteCoordinateGuiCommand(
            ...
            DifferentialDriveKinematics kinematics,
            Subsystem... requirements) {
        m_trajectorySupplier = requireNonNullParam(trajectorySupplier, "trajectory", "BaseRamseteCoordinateGuiCommand");
